...
::: notes
log transform on Bikes, Maori, and Bus; Bikes and Maori appear normal(ish); bus appears relatively uniform with many similar observations
:::
...
::: {.column width="50%"}
![](ols_spatiallag_noanyuni_residuals.png){fig-align="center" width="1100"}
:::
:::
...
::: {.column width="50%"}
![](ols_spatialerror_noanyuni_residuals.png){fig-align="center"}
:::
:::
