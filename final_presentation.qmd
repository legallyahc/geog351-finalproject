...
## Methods: Variables {.scrollable .smaller}

To avoid collinearity between the predictors and the predicted variables, I chose to use the Index of Multiple Deprivation that excludes education data.
...
`No Qualification`: % of people with no proof of education

`Some-University`: % of people who have at least some university education

`Post-Tertiary`: % of people with post-bachelor's education

`Maori descent`: % of people with Maori heritage

`Drive a private car, truck, or van`: % of people who drive their own vehicle to work

`Public bus`: % of people who take the bus to work
